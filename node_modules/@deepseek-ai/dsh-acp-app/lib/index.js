...
*/
function acpCommand() {
	return new Command().name("dsh --profile acp").description("Serve automation clients over Agent Client Protocol stdio.").helpOption("-h, --help", "show this help").addHelpText("after", `
Example:
...
//#endregion
export { ACP_APP_STARTUP_SERVICE, apply, inject, name };
