		...
		for (let attempt = 0; attempt < STABLE_OBSERVATION_ATTEMPTS; attempt += 1) {
			...
			if (persistence !== void 0) try {
				...
				for (const entry of persisted.values()) {
					...
					entry.loaded = observeSession(loaded.meta, loaded.inheritedEventCount, loaded.events);
				}
				assertNotAborted(signal);
...
function sameHeader(a, b) {
	return a.version === b.version && a.id === b.id && a.createdAt === b.createdAt && a.cwd === b.cwd && a.parentSession === b.parentSession && a.isSeeded === b.isSeeded && (a.delegationDepth ?? 0) === (b.delegationDepth ?? 0) && a.agentPreset === b.agentPreset;
}
