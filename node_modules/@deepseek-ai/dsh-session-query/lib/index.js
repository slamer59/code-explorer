...
import { Session, SessionLogOffset, SessionSeq, foldSurface, isSurfaceEvent, snapshotSessionEvent } from "@deepseek-ai/dsh-session";
...
function assertSessionHeadersCompatible(a, b) {
	if (a.version !== b.version || a.id !== b.id || a.createdAt !== b.createdAt || a.cwd !== b.cwd || a.parentSession !== b.parentSession || a.isSeeded !== b.isSeeded || (a.delegationDepth ?? 0) !== (b.delegationDepth ?? 0)) throw new SessionQueryError(`session source headers conflict for session "${a.id}"`, "SESSION_QUERY_SOURCE_CONFLICT");
}
//#endregion
...
var SessionObservationReader = class {
	...
	*/
	...
	preparedProjections(observation, events) {
		...
		return cache === void 0 ? registry.hydrate(prepared, {}, events, SessionLogOffset(0)) : cache.hydratePrepared(prepared, events);
	}
};
